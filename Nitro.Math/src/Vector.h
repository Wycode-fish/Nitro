...
namespace Nitro
{
	namespace Math
	{
        ...
        public:
            ...
            INLINE Vector3(const FVEC3& v) { m_vec = XMLoadFloat3(&v); }
            INLINE Vector3(const Vector3& v) { m_vec = v; }
            INLINE Vector3(Scalar s) { m_vec = s; }
            INLINE explicit Vector3(Vector4 v); // IMPL AFTER VEC4 DECLARATION
            INLINE explicit Vector3(const M128 vec) { m_vec = vec; }
            ...
            // @ XMVectorPermute : https://docs.microsoft.com/en-us/windows/win32/api/directxmath/nf-directxmath-xmvectorpermute
        ...
        public:
            ...
            INLINE explicit Vector4(const M128 vec) { m_vec = vec; }
        ...
        {
            Scalar W = v.GetW();
            // XMVectorSelect: https://docs.microsoft.com/en-us/windows/win32/api/directxmath/nf-directxmath-xmvectorselect
        ...
        {
        public:
            INLINE BoolVector(const M128 vec) { m_vec = vec; }
            INLINE operator M128() const { return m_vec; }
        protected:
            M128 m_vec;
        };
